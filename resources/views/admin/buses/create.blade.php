            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100 p-6 sm:p-8">
                ...
                <form action="{{ route('admin.buses.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm" placeholder="Contoh: LokaBus Trans Jawa" required>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="facilities" rows="3" class="w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm" placeholder="Contoh: AC, Toilet, Reclining Seat, Colokan USB">{{ old('facilities') }}</textarea>
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm py-2 px-6 rounded-lg transition shadow-sm">Simpan Data</button>
                    </div>
                </form>
